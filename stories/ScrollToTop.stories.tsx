  ...
  public render() {
    ...
    return (
      <div>
        ...
        <ScrollToTopButton
          scrollContainerElement={this.state.scrollContainer || window}
        />
      </div>
    );
  }
...
stories.add(
  'Scroll to Top with a scrolling div viewport [DontImageStoryshot]',
  () => <ExampleContainer scrollViewport />
);

stories.add(
  'Scroll to Top with window scrolling viewport [DontImageStoryshot]',
